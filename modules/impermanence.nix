    ...
    in
    {
      ...
      options.persistence = {
        extraDirectories = mkOption {
          ...
          default = [ ];
          description = "Additional directories to persist under /persist.";
        };
        extraFiles = mkOption {
          type = types.listOf types.str;
          default = [ ];
          description = "Additional files to persist under /persist.";
        };
      };
      config = {
        # Much thanks to:
        ...
        environment.persistence."/persist" = {
          ...
          ++ config.persistence.extraDirectories;
          files = [
            "/etc/machine-id"
            # needed for ssh
